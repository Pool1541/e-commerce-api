...
const { productTitleExists, categoryExists, productExist } = require('../helpers/db-validations');
...
router.post(
  ...
  [
    ...
    check('price', 'price is required').notEmpty().isNumeric().withMessage('price is not a number'),
